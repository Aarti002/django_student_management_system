...
urlpatterns = [
    ...
    path('admin_sendnotification_staff/<str:staff_id>',
         HodViews.admin_sendnotification_staff, name="admin_sendnotification_staff"),
    path('admin_sendnotification_student/<str:student_id>',
         HodViews.admin_sendnotification_student, name="admin_sendnotification_student"),
    path('notify_staff/<str:staff_id>',
         HodViews.notify_staff, name="notify_staff"),
    path('notify_student/<str:student_id>',
         HodViews.notify_student, name="notify_student"),
    ...
    path('staff_notification_reply/<str:notice_id>',
         StaffViews.staff_notification_reply, name="staff_notification_reply"),
    path('staff_notification_reply_save', StaffViews.staff_notification_reply_save,
         name="staff_notification_reply_save"),
    path('delete_notification/<str:notice_id>',
         StaffViews.delete_notification, name="delete_notification"),
    path('get_students', StaffViews.get_students, name="get_students"),
    ...
    path('student_view_attendance_save', StudentViews.student_view_attendance_save,
         name="student_view_attendance_save"),
    ...
    path('edit_staff_reply/<str:feed_id>',
         HodViews.edit_staff_reply, name="edit_staff_reply"),
    path('edit_staff_reply_save', HodViews.edit_staff_reply_save,
         name="edit_staff_reply_save"),
    path('edit_student_reply/<str:feed_id>',
         HodViews.edit_student_reply, name="edit_student_reply"),
    path('notify_staff/<str:feed_id>',
         HodViews.notify_staff, name="notify_staff"),
    path('edit_student_reply_save', HodViews.edit_student_reply_save,
         name="edit_student_reply_save"),
    ...
    path('delete_subject/<str:subject_id>',
         HodViews.delete_subject, name="delete_subject"),
    path('delete_session/<str:session_id>',
         HodViews.delete_session, name="delete_session"),
    path('present_student_attendance/<str:session_id>',
         HodViews.present_student_attendance, name="present_student_attendance"),
    ...
    path('student_notification_reply/<str:notice_id>',
         StudentViews.student_notification_reply, name="student_notification_reply"),
    path('student_notification_reply_save', StudentViews.student_notification_reply_save,
         name="student_notification_reply_save"),
    path('delete_notification/<str:notice_id>',
         StudentViews.delete_notification, name="delete_notification"),
